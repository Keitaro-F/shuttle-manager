...
4. 報告忘れ通知をMVP後の最優先候補とするが、練習終了時刻と対象拠点の情報源、通知回数、LINEの送信通数を決めるまで実装しない
5. 購入管理、グラフ、認証は今回着手せず、報告忘れ通知の要件決定後に改めて優先順位を判断する
...
- [x] Web画面の待機表示を追加している
- [x] 報告忘れ通知を含む改善候補の優先度と未決事項を記録している
...
| 2026-08-11 | 報告忘れ通知をMVP後の最優先候補とし、未決事項を確定するまでは実装しない |
